...
/**
 * The type Concept scheme map mutable bean.
 */
public class ConceptSchemeMapMutableBeanImpl extends ItemSchemeMapMutableBeanImpl implements ConceptSchemeMapMutableBean {
    ...
    /**
     * Instantiates a new Concept scheme map mutable bean.
     */
     ...
     */
    public ConceptSchemeMapMutableBeanImpl(ConceptSchemeMapBean conBean) {
        super(conBean);
    }
}
