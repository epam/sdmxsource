...
/**
 * The type Organisation unit mutable bean.
 */
public class OrganisationUnitMutableBeanImpl extends OrganisationMutableBeanImpl implements OrganisationUnitMutableBean {
    ...
    /**
     * Instantiates a new Organisation unit mutable bean.
     *
     * @param bean the bean
     */
    public OrganisationUnitMutableBeanImpl(OrganisationUnitBean bean) {
        super(bean);
    }
