...
/**
 * The type Item map mutable bean.
 */
public class ItemMapMutableBeanImpl extends MutableBeanImpl implements ItemMapMutableBean {
    ...
    /**
     * Instantiates a new Item map mutable bean.
     */
     ...
     * @param bean the bean
     */
    public ItemMapMutableBeanImpl(ItemMapBean bean) {
        super(bean);
