...
/**
 * The type Organisation scheme map mutable bean.
 */
public class OrganisationSchemeMapMutableBeanImpl extends ItemSchemeMapMutableBeanImpl implements OrganisationSchemeMapMutableBean {

    private static final long serialVersionUID = 1L;

    /**
     * Instantiates a new Organisation scheme map mutable bean.
     */
     ...
     * @param bean the bean
     */
    public OrganisationSchemeMapMutableBeanImpl(OrganisationSchemeMapBean bean) {
        super(bean);
    }
}
