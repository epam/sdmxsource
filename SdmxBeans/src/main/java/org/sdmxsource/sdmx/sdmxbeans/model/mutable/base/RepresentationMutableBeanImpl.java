...
/**
 * The type Representation mutable bean.
 */
public class RepresentationMutableBeanImpl extends MutableBeanImpl implements RepresentationMutableBean {
    ...
    /**
     * Instantiates a new Representation mutable bean.
     */
     ...
     * @param bean the bean
     */
    public RepresentationMutableBeanImpl(RepresentationBean bean) {
        super(bean);
        if (bean.getTextFormat() != null) {
            this.textFormat = new TextFormatMutableBeanImpl(bean.getTextFormat());
        }
        if (bean.getRepresentation() != null) {
            this.representationRef = bean.getRepresentation().createMutableInstance();
        }
    }
