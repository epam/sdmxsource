...
/**
 * The type Cross referencing tree.
 */
public class CrossReferencingTreeImpl implements CrossReferencingTree {
    ...
    private List<CrossReferencingTree> referencingBeans = new ArrayList<CrossReferencingTree>();

    /**
     * Instantiates a new Cross referencing tree.
     *
     * @param maintainableBean the maintainable bean
     * @param referencingBeans the referencing beans
     */
    ...
    public List<CrossReferencingTree> getReferencingStructures() {
        return new ArrayList<CrossReferencingTree>(referencingBeans);
    }
}
