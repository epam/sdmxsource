...
/**
 * Assembles a CategoryBean to facilitate Builder&lt;K,V&gt; for the top level bean.
...
public class CategoryBeanAssembler extends NameableBeanAssembler implements Assembler<CategoryType, CategoryBean> {
    ...
    @Override
    public void assemble(CategoryType assembleInto, CategoryBean assembleFrom) throws SdmxException {
