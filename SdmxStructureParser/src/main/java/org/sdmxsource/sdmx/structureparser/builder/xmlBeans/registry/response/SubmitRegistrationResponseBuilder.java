...
public interface SubmitRegistrationResponseBuilder {
     ...
     * @return xml object
     */
    XmlObject buildResponse(Map<RegistrationBean, Throwable> responses, SDMX_SCHEMA schemaVersion);
     ...
     * @return xml object
     */
    XmlObject buildErrorResponse(Throwable response, SDMX_SCHEMA schemaVersion);
