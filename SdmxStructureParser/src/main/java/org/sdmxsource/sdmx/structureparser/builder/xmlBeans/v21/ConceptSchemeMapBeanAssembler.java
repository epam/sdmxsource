...
/**
 * Assembles a ConceptSchemeMap to facilitate Builder&lt;K,V&gt; for the top level bean.
...
public class ConceptSchemeMapBeanAssembler extends AbstractItemSchemeMapBeanAssembler implements Assembler<ConceptSchemeMapType, ConceptSchemeMapBean> {
    ...
    @Override
    public void assemble(ConceptSchemeMapType assembleInto, ConceptSchemeMapBean assembleFrom) throws SdmxException {
    ...
    protected ItemAssociationType createNewMap(ItemSchemeMapType assembleInto) {
        return ((ConceptSchemeMapType) assembleInto).addNewConceptMap();
    }
