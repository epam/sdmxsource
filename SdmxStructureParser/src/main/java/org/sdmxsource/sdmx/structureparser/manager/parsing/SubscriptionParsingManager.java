...
/**
 * The interface Subscription parsing manager.
 */
public interface SubscriptionParsingManager {
     ...
     * @return list list
     */
    List<SubscriptionBean> parseSubscriptionXML(ReadableDataLocation dataLocation);
