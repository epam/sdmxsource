...
/**
 * Assembles a OrganisationSchemeMap to facilitate Builder&lt;K,V&gt; for the top level bean.
...
public class OrganisationSchemeMapBeanAssembler extends AbstractItemSchemeMapBeanAssembler implements Assembler<OrganisationSchemeMapType, OrganisationSchemeMapBean> {
    ...
    @Override
    public void assemble(OrganisationSchemeMapType assembleInto, OrganisationSchemeMapBean assembleFrom) throws SdmxException {
        // Populate it from inherited super
        assembleSchemeMap(assembleInto, assembleFrom);
    }

    @Override
    protected ItemAssociationType createNewMap(ItemSchemeMapType assembleInto) {
        return ((OrganisationSchemeMapType) assembleInto).addNewOrganisationMap();
    }
