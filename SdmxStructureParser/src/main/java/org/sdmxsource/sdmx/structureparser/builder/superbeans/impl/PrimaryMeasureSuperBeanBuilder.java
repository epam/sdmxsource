...
public class PrimaryMeasureSuperBeanBuilder extends ComponentSuperBeanBuilder<PrimaryMeasureSuperBean, PrimaryMeasureBean> {
    ...
    public PrimaryMeasureSuperBean build(PrimaryMeasureBean buildFrom,
        ...
        return new PrimaryMeasureSuperBeanImpl(buildFrom, codelist, concept);
    }
