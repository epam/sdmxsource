...
public class SdmxErrorWriterFactory implements ErrorWriterFactory {
    ...
    /**
     * Instantiates a new Sdmx error writer factory.
     */
     ...
     * Instantiates a new Sdmx error writer factory.
     *
     * @param errorWriterEngine the error writer engine
     */
    public SdmxErrorWriterFactory(final ErrorWriterEngineV21 errorWriterEngine) {
        this.errorWriterEngine = errorWriterEngine != null ? errorWriterEngine : new ErrorWriterEngineV21();
    }
