...
/**
 * The type Submit registration builder.
 */
public class SubmitRegistrationBuilder {
     ...
     */
    public RegistryInterfaceDocument buildRegistryInterfaceDocument(Collection<RegistrationBean> buildFrom, DATASET_ACTION action) throws SdmxException {
