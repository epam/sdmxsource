...
/**
 * The type Structure query builder manager.
 */
public class StructureQueryBuilderManagerImpl implements StructureQueryBuilderManager {
    ...
    /**
     * Instantiates a new Structure query builder manager.
     *
     * @param factories the factories
     */
    public StructureQueryBuilderManagerImpl(final StructureQueryFactory[] factories) {
    ...
    public <T> T buildStructureQuery(RESTStructureQuery structureQuery, StructureQueryFormat<T> structureQueryFormat) {
        for (StructureQueryFactory currentFactory : factories) {
            StructureQueryBuilder<T> builder = currentFactory.getStructureQueryBuilder(structureQueryFormat);
            if (builder != null) {
