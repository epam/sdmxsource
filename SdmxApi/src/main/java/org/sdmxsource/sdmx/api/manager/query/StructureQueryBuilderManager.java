...
/**
 * The interface Structure query builder manager.
 */
public interface StructureQueryBuilderManager {
     ...
     * @param structureQuery       the query to build a representation of
     * @param structureQueryFormat the required format
     * @return representation of query in the desired format.
     */
    <T> T buildStructureQuery(RESTStructureQuery structureQuery, StructureQueryFormat<T> structureQueryFormat);
