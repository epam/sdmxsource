 ...
 */
public interface SdmxMutableSubscriptionPersistenceManager {
     ...
     * @return subscription mutable bean
     */
    SubscriptionMutableBean saveSubscription(SubscriptionMutableBean subscriptionBean);
     ...
     * @param subscriptionBean the subscription bean
     */
    void deleteSubscription(SubscriptionMutableBean subscriptionBean);
}
