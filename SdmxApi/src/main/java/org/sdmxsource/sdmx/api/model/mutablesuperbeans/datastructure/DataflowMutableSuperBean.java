 ...
 *
 */
public interface DataflowMutableSuperBean extends MaintainableMutableSuperBean {

    public DataStructureMutableSuperBean getDataStructure();

    public void setDataStructure(DataStructureMutableSuperBean dataStructure);
