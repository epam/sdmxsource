...
public interface MetadataWriterEngine {
    ...
    /**
     * Writes one or more metadata sets to the output stream
     *
     * @param out         the out
     * @param metadataSet the metadata set
     */
    void writeMetadataSet(OutputStream out, MetadataSetBean... metadataSet);
