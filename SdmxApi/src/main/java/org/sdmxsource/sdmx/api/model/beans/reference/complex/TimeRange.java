...
public interface TimeRange {
     ...
     *
     * @return true then start date and end date both have a value, and the range is between the start and end dates.
     */
    boolean isRange();
     ...
     *
     * @return true if the start date is included in the range
     */
     ...
     *
     * @return true if the end date is included in the range
     */
