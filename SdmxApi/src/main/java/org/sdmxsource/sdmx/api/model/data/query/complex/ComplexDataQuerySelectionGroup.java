 ...
 * @author fch
 */
public interface ComplexDataQuerySelectionGroup extends Serializable {
     ...
     */
    ComplexDataQuerySelection getSelectionsForConcept(String componentId);
     ...
     *
     * @return the set of selections for this group. These DataQuerySelections are implicitly ANDED together.
     */
    Set<ComplexDataQuerySelection> getSelections();
     ...
     *
     * @return primary measure value
     */
    Set<ComplexComponentValue> getPrimaryMeasureValue();
