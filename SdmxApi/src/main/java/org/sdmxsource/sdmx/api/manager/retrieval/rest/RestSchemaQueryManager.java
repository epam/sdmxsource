 ...
 */
public interface RestSchemaQueryManager {

    /**
     * Writes the
     *
     * @param schemaQuery the schema query
     * @param format      the format
     * @param out         the out
     */
    void writeSchema(RESTSchemaQuery schemaQuery, SchemaFormat format, OutputStream out);
}
