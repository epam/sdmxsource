...
public interface SchemaWriterEngine {
     ...
     */
    void generateSchema(OutputStream out, DataStructureSuperBean dsd, String targetNamespace, Map<String, Set<String>> constraintsMap);
     ...
     * @param constraintsMap            the map key is the dimension id, values is the valid codes for the dimension
     */
    void generateCrossSectionalSchema(OutputStream out, DataStructureSuperBean dsd, String targetNamespace, String crossSectionalDimensionId, Map<String, Set<String>> constraintsMap);
