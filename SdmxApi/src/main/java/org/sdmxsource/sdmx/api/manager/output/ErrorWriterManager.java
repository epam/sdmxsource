...
public interface ErrorWriterManager {
     ...
     *
     * @param th           the th
     * @param out          the stream to write the error response to
     * @param outputFormat the format to write the error message in
     * @return an HTTP status code based on the error type
     */
    int writeError(Throwable th, OutputStream out, ErrorFormat outputFormat);
}
