...
/**
 * Wraps a metadata report bean, has all referenced structures by compoisition
 */
public interface MetadataReportSuperBean extends SuperBean {
    ...
    /**
     * Override from parent - returns the MetadataReportBean that was used to build this superbean
     */
    @Override
